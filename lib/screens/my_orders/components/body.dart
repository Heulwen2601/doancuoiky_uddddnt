...
import 'package:do_an_ck_uddddnt/components/product_short_detail_card.dart';
...
import 'package:do_an_ck_uddddnt/screens/my_orders/components/product_review_dialog.dart';
...
import 'package:do_an_ck_uddddnt/services/data_streams/ordered_products_stream.dart';
    ...
    return StreamBuilder<List<String>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          if (orderedProductsIds?.isEmpty ?? true) {
            return Center(
          ...
          return ListView.builder(
            ...
            itemCount: orderedProductsIds?.length ?? 0,
                    ...
                    onPressed: () async {
                      ...
                      try {
                        ...
                        if (prevReview == null) {
                          prevReview = Review(
                            currentUserUid,
                            reviewerUid: currentUserUid, feedback: '',
                          );
                        }
                      }
                      ...
                      final result = await showDialog(
                        ...
                        builder: (context) {
                          return ProductReviewDialog(
                            review: prevReview ?? Review(currentUserUid, reviewerUid: currentUserUid, feedback: ''),
                          );
                        },
                      );
                      if (result is Review) {
