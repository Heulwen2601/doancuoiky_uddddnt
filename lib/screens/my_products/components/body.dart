...
import 'package:do_an_ck_uddddnt/services/data_streams/users_products_stream.dart';
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: StreamBuilder<List<String>>(
                      stream: usersProductsStream.stream as Stream<List<String>>,
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          final productsIds = snapshot.data!;
                          if (productsIds?.isEmpty ?? true) {
                            return Center(
                          ...
                          return ListView.builder(
                            ...
                            itemCount: productsIds?.length ?? 0,
